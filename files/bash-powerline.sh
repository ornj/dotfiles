...
__powerline() {
    ...
    readonly COLOR_VIRTUALENV='\[\033[1;32m\]' # light green
    ...
    ps1() {
        ...
        if shopt -q promptvars; then
            ...
            __powerline_virtualenv="$(__virtualenv_info)"
            local git="$COLOR_GIT\${__powerline_git_info}$RESET"
            local venv="$COLOR_VIRTUALENV\${__powerline_virtualenv}$RESET"
        else
